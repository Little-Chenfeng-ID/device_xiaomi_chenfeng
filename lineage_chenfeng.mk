...
PRODUCT_BUILD_PROP_OVERRIDES += \
    BuildDesc="chenfeng_global-user 15 AQ3A.240912.001 OS2.0.102.0.VNJINXM release-keys" \
    BuildFingerprint=Xiaomi/chenfeng_global/chenfeng:15/AQ3A.240912.001/OS2.0.102.0.VNJINXM:user/release-keys \
    DeviceName=chenfeng
